...
public class TriangleTests {
    ...
    public void findIntersections() {
        ...
        ray = new Ray(new Point3D(-1,-3,-2),new Vector(new Point3D(1,3,2)));
        ...
        ray = new Ray(new Point3D(-1,-1,-1),new Vector(new Point3D(3,3,1)));
        ...
        ray = new Ray(new Point3D(-1,-1,-1),new Vector(new Point3D(3,3,2)));
        result = triangle.findIntersections(ray);
        ...
        ray = new Ray(new Point3D(-1,-1,-1),new Vector(new Point3D(3,0,1)));
        result = triangle.findIntersections(ray);
