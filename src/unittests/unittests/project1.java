...
public class project1 {
    ...
    public void picture() {
        ...
        scene.setAmbientLight(
                new AmbientLight(
                        new Color(java.awt.Color.WHITE), 0.15));
        scene.setCamera(
                new Camera(
                        new Point3D(0, 0, -1000),
                        new Vector(0, 0, 1),
                        new Vector(0, -1, 0))
                        .setDOF(1).setAperture(5d)
                        .setNumOfRays(300)
...
//                new Sphere(colorPink,sphereMaterial, 10, new Point3D(-80, -35, 70)),
//                new Triangle(
//                        colorBlue,
//                        new Material(0.8, 0.2, 300),
//                        new Point3D(-110, -25, 100),
//                        new Point3D(-60, -25, 100),
//                        new Point3D(-80, -100, 100))
        );
