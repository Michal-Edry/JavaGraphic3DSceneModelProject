...
public class LightsTests {
    ...
    public void sphereAllLights() {
        ...
        scene.addGeometries(
                new Sphere(new Color(200,20,255), new Material(0.5, 0.5, 100), 50, new Point3D(0, 0, 50)));

        scene.addLights(new DirectionalLight(new Color(500, 300, 0), new Vector(1, -1, 1)),
                        new PointLight(new Color(500, 300, 0), new Point3D(150, 50, -50),
                                1, 0.00001, 0.000001),
                        new SpotLight(new Color(500, 300, 0), new Point3D(0, -200, -200),
                                new Vector(1, -1, 2), 1, 0.00000000001, 0.00000000001));
    ...
    public void triangleAllLights() {
        ...
        scene.addLights(new DirectionalLight(new Color(500, 0, 0), new Vector(0, 0, 1)),
                new PointLight(new Color(100, 300, 50),
                        new Point3D(10, 10, 130),
                        1, 0.0005, 0.0005),
                new SpotLight(new Color(500, 250, 250),
                        new Point3D(0, 70, 120), new Vector(-2, 2, 1),
                        1, 0.0001, 0.000005));

        ImageWriter imageWriter = new ImageWriter("triangleAllLights", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
